...
const Hero = () => {
    return (
        <section id="hero" style={{padding: `${media(0, 70)} 0`}}>
            <div className="container">
                <div className="hero-general">
                    <div>
                        <h1 className="hero-general__title" style={{fontSize: media(30, 50), marginBottom: media(20, 60)}}>Курсанбай Жапаров атындагы
                            орто мектеби</h1>
